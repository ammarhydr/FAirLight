...
from SAC_agent_one import SACAgentOne
from SAC_colight import SACAgentColight
from Colight_torch import ColightTorch
from DQN_torch import DQNTorch
...
DIC_EXP_CONF = {
    ...
    "LIST_MODEL_NEED_TO_UPDATE":
        ["Deeplight", "SimpleDQN", "CoLight","GCN", "SimpleDQNOne","Lit", "SAC", "SAC_One", "SAC_Colight", "Colight_torch", "DQN_torch"],
    "MODEL_POOL": False,
    "NUM_BEST_MODEL": 3,
    "PRETRAIN": True,
...
DIC_AGENTS = {
    ...
    'SAC': SACAgent,
    'SAC_One': SACAgentOne,
    'SAC_Colight': SACAgentColight,
    'Colight_torch': ColightTorch,
    'DQN_torch': DQNTorch,
    # 'GCN': GCNAgent,
