    ...
    def generate(self):
        ...
        while not done and step_num < int(self.dic_exp_conf["RUN_COUNTS"]/self.dic_traffic_env_conf["MIN_ACTION_TIME"]):
            ...
            for i in range(self.dic_traffic_env_conf["NUM_AGENTS"]):
                ...
                if self.dic_exp_conf["MODEL_NAME"] in ["CoLight","GCN", "SimpleDQNOne", "SAC_One", "SAC_Colight", "Colight_torch", "DQN_torch"]:
                    one_state = state
                    if self.dic_exp_conf["MODEL_NAME"] in ['CoLight', 'SAC_Colight', 'Colight_torch', 'DQN_torch']:
